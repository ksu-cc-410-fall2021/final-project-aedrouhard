"""File for the CertainSex violence class.

This is the file with the class for CertainSex violence
...
class CertainSex(Violence):
    """CertainSex violence class.
    ...
    def __init__(self) -> None:
        """Initiater for the CertainSex class.
    ...
    def __str__(self) -> str:
        ...
        """
        return "{} Certain Sex Violence".format(self._severity)

    def __eq__(self, value: object) -> bool:
        """Equality determiner.

        This method determines if an inputted object is equal
        to a CertainSex object.

        Args:
            value: The object being compared to the CertainSex object.

        Returns:
            A boolian value telling if the object input is equal
            to a CertainSex object.
        """
        if isinstance(value, CertainSex):
