"""File for the Impulsivity Sign.

This is the file with the class for the Impulsivity Sign
...
class Impulsivity(Sign):
    """Impulsivity Sign class.
    ...
    def __init__(self) -> None:
        """Initiater for the Impulsivity class.
    ...
    def __eq__(self, value: object) -> bool:
        ...
        to a Impulsivity object.

        Args:
            value: The object being compared to the Impulsivity object.

        Returns:
            A boolian value telling if the object input is equal
            to a Impulsivity object.
        """
        if isinstance(value, Impulsivity):
