"""File for the WetBed Sign.

This is the file with the class for the WetBed Sign
...
class WetBed(Sign):
    ...
    def __init__(self) -> None:
        """Initiater for the WetBed class.
    ...
    def __eq__(self, value: object) -> bool:
        ...
        Args:
            value: The object being compared to the WetBed object.

        Returns:
            A boolian value telling if the object input is equal
            to a WetBed object.
        """
        if isinstance(value, WetBed):
