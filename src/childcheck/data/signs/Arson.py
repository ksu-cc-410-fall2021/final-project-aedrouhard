"""File for the Arson Sign.

This is the file with the class for the Arson Sign
...
class Arson(Sign):
    ...
    def __str__(self) -> str:
        ...
        """
        if self.__frequent:
            note = "Frequently committing arson"
        else:
            note = "Committing arson"
        return note
    ...
    def __eq__(self, value: object) -> bool:
        ...
        Args:
            value: The object being compared to the Arson object.

        Returns:
            A boolian value telling if the object input is equal
            to a Arson object.
        """
        if isinstance(value, Arson):
