"""File for the NoEmpathy panel.

This is the file determines how the
panel will look for the NoEmpathy sign.
...
class NoEmpathyPanel(FactorPanel):
    """NoEmpathy panel class.
    ...
    def __init__(self, master, factor=None,
        ...
        """Initiater for the NoEmpathy panel class.
        ...
        title = tk.Label(master=self, text="NoEmpathy")
    ...
    def action_performed(self, text):
        ...
        if text == "save":
            ...
            dialog = HelpDialog(self.__master, title="Factor Definition",
                                message="Use this link: https://micheleborba.com/building-moral-intelligence-and-character/when-to-worry-signs-that-a-child-may-have-low-empathy/",
                                options=["Exit"])
