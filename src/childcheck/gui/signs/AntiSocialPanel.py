"""File for the AntiSocial panel.

This is the file determines how the
panel will look for the AntiSocial sign.
...
class AntiSocialPanel(FactorPanel):
    """AntiSocial panel class.
    ...
    def __init__(self, master, factor=None,
        ...
        """Initiater for the AntiSocial panel class.
        ...
        title = tk.Label(master=self, text="AntiSocial")
    ...
    def action_performed(self, text):
        ...
        if text == "save":
            ...
            dialog = HelpDialog(self.__master, title="Factor Definition",
                                message="Use this link: https://www.choosingtherapy.com/antisocial-behavior/",
                                options=["Exit"])
