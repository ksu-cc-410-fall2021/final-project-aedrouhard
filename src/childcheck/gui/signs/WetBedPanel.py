"""File for the WetBed panel.

This is the file determines how the
panel will look for the WetBed sign.
...
class WetBedPanel(FactorPanel):
    ...
    def __init__(self, master, factor=None,
        ...
        """Initiater for the WetBed panel class.
        ...
        title = tk.Label(master=self, text="WetBed")
    ...
    def action_performed(self, text):
        ...
        if text == "save":
            ...
            dialog = HelpDialog(self.__master, title="Factor Definition",
                                message="Use this link: https://my.clevelandclinic.org/health/diseases/15075-bedwetting/",
                                options=["Exit"])
