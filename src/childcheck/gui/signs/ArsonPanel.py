"""File for the Arson panel.

This is the file determines how the
panel will look for the Arson sign.
...
class ArsonPanel(FactorPanel):
    ...
    def __init__(self, master, factor=None,
        ...
        """Initiater for the Arson panel class.
        ...
        title = tk.Label(master=self, text="Arson")
    ...
    def action_performed(self, text):
        ...
        if text == "save":
            ...
            dialog = HelpDialog(self.__master, title="Factor Definition",
                                message="Use this link: https://www.sciencedirect.com/topics/medicine-and-dentistry/arson/",
                                options=["Exit"])
