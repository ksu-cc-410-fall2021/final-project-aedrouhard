"""File for the CertainSex panel.

This is the file determines how the CertainSex
...
class CertainSexPanel(FactorPanel):
    """CertainSex panel class.
    ...
    def __init__(self, master, factor=None,
        ...
        """Initiater for the CertainSex panel class.
        ...
        title = tk.Label(master=self, text="Certain Sex Violence")
    ...
    def action_performed(self, text):
        ...
        if text == "save":
            ...
            dialog = HelpDialog(self.__master, title="Factor Definition",
                                message="Use this link: https://commission.europa.eu/strategy-and-policy/policies/justice-and-fundamental-rights/gender-equality/gender-based-violence/what-gender-based-violence_en/",
                                options=["Exit"])
